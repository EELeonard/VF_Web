  ...
  return (
    <footer id="kontakt">
      <div className="footer-top">
        <div><Link className="brand footer-brand" href={english ? "/en" : "/"}><span className="brand-mark">VF</span><span>VIENNA <b>FLIGHT</b></span></Link><p>Flightsimulation & Flighttraining OG<br />Schönngasse 15-17/2/Top 3, 1020 {english ? "Vienna" : "Wien"}</p></div>
